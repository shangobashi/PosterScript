...
title       = "Mondo Bot"
fieldNames  = ["Email","Password","Poster",".*Poster.*ariant.*","Gift Card 1","Gift Card 2"]
...
printnamevariant=fieldValues[3]
gift=fieldValues[4]
gift2=fieldValues[5]

only_var=re.compile(printnamevariant, re.IGNORECASE)
